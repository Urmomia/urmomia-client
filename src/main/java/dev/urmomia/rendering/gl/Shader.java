...
package dev.urmomia.rendering.gl;
...
public class Shader {
    ...
    public Shader(String vertexPath, String fragmentPath) {
        ...
        if (!compiled) {
            ...
            MainClient.LOG.error("Failed to compile vertex shader ({}):\n{}", vertexPath, error);
            return;
        }
        ...
        if (!compiled) {
            ...
            MainClient.LOG.error("Failed to compile fragment shader ({}):\n{}", fragmentPath, error);
            return;
        }
    ...
    private String read(String path) {
        try {
            InputStream in = MinecraftClient.getInstance().getResourceManager().getResource(new Identifier("urmomia-client", path)).getInputStream();
