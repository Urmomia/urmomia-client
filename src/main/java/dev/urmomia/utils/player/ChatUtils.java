...
public class ChatUtils {
    ...
    private static BaseText getPrefix(String title, PrefixType type) {
        ...
        if (Config.get().rainbowPrefix) {
            ...
            meteor.append(new LiteralText("a").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
        } else {
            meteor = new LiteralText("Urmomia");
            meteor.setStyle(meteor.getStyle().withFormatting(Formatting.LIGHT_PURPLE));
        }
